...
function selectPostgresInstance(postgresInstances) {
...
function attachPostgresInstance(graphqlInstance, postgresInstances) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, selectPostgresInstance(postgresInstances)];
                case 1:
                    instance = _a.sent();
...
exports.attachPostgresInstance = attachPostgresInstance;
//# sourceMappingURL=attachPostgresInstance.js.map