            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (!(((_c = (_b = this.callerInstance.getPostgresInstance()) === null || _b === void 0 ? void 0 : _b.getContainerController()) === null || _c === void 0 ? void 0 : _c.status) !== "up")) return [3, 2];
                                ...
                                return __generator(this, function (_a) {
                                    DockerodeHelper.getPort(this.getPortNumber(true), ports)
                                        ...
                                        DockerodeHelper.up(_this.getDockerJson(), _this.getEnv(), _this.portNumber, _this.callerInstance.getName())
                                            .then(function (_a) {
                                            var status = _a.status, portNumber = _a.portNumber, containerId = _a.containerId, dockerfile = _a.dockerfile;
                                            _this.setStatus(status);
                                            _this.setPortNumber(portNumber);
                                            _this.setContainerId(containerId);
                                            _this.setDockerfile(dockerfile);
